...
void bracket_tool(stack <Bracket>* bracket_stack, char cur, int str){
	...
	// иначе добавляем в стек
				...
				// br - brackets.begin() это разница между указатель на найденную скобку в массиве brackets и указателем на первый элемент, это дает индекс элемента в массиве
